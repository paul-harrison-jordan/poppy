    ...
    <AppShell>
      <div className="w-full max-w-3xl mx-auto space-y-10 relative">
        ...
        <div className="bg-white/90 rounded-b-2xl shadow-sm p-8 text-primary font-sans space-y-8">
          ...
          {/* V0 API Key Configuration Section */}
          <div className="space-y-4 pb-8 border-b border-gray-200">
            <h2 className="text-2xl font-semibold text-poppy">Design Mode Configuration</h2>
            <p className="text-lg">To use Design Mode, you need a v0 API key from <a href="https://v0.dev" target="_blank" rel="noopener noreferrer" className="text-poppy hover:underline">v0.dev</a>:</p>
