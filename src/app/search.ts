            ...
            messages: [
                {
                    ...
                    I've included instructions for how to think and write PRDs like a product manager with" ${examplesOfHowYouThink} "I've also included background on how to think like the K:Service team" ${pillarGoalsKeyTermsBackground} "I've included a doc that starts with Building a Product That Grows With Its Users to demonstrate my personal philosophy on how we should approach building a product to cross sell to existing users" ${howYouThinkAboutProduct} "I've included a doc that outlines the strategic goals of the Unified Inbox product for the rest of the year" ${teamStrategy} 
                    
                    
                    
                    "I've included example text from work that my team has already done that I want for you to use as additional context for relevant features and terms" ${additionalContext} "I've asked you to write a PRD for the following question" ${question} "I've also included a list of questions and answers about the PRD to provide additional clarity around how we should approach the PRD." ${questions} "When I ask you to write a doc, I want you to evaluate the Job to be Done statement I provide from each perspective (Product Manager, K:Service Team, and Building a product that grows with its users) before beginning to write the PRD. Once done with that step, I want you to write the document with a focus on narrow scope, highly detailed breakdowns of which feature will support which part of the JTBD, and an open questions section that interrogates the JTBD from each of your perspectives (K:service, Product, my philosophy) our edits should be returned in markdown format`,
                },
            ],
        });  
